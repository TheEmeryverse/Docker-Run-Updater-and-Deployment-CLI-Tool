...
Current release is fully compatible with Fedora 40 SE, MacOS Sequoia 15.2, Docker Desktop, and 'brew install docker'. Other Linux distributions should work, just ensure bash is being used to execute.
